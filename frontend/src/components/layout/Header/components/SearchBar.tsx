          ...
          <div className="absolute top-full mt-2 w-full bg-white dark:bg-[#1A1A1A] rounded-2xl shadow-2xl border border-gray-100 dark:border-white/10 overflow-hidden z-[100] animate-in fade-in slide-in-from-top-2 duration-200">
            {suggestions.map((s, i) => (
              ...
              >
                ...
                {s.category && (
                  <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-primary/60 bg-primary/5 px-2 py-0.5 rounded shrink-0 max-w-[35%] sm:max-w-none truncate">
                    {s.category}
                  </span>
                )}
              </button>
